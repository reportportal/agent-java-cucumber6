...
public class ItemTreeUtils {
	...
	public static TestItemTree.ItemTreeKey createKey(String text) {
		return TestItemTree.ItemTreeKey.of(text);
	}

	public static Optional<TestItemTree.TestItemLeaf> retrieveLeaf(URI featureUri, TestItemTree testItemTree) {
		return ofNullable(testItemTree.getTestItems().get(createKey(featureUri)));
	}

	public static Optional<TestItemTree.TestItemLeaf> retrieveLeaf(URI featureUri, int lineNumber, TestItemTree testItemTree) {
	...
	public static Optional<TestItemTree.TestItemLeaf> retrieveLeaf(URI featureUri, int lineNumber, String text, TestItemTree testItemTree) {
