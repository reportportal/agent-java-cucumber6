Feature: Image embedding feature

  Scenario: Embed a correct mime type image
    Given I have a dummy step to make a screenshot with correct mime type

  Scenario: Embed an incorrect mime type image
    Given I have a dummy step to make a screenshot with incorrect mime type

  Scenario: Embed a partially correct mime type image
